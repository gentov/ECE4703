...
interrupt void serialPortRcvISR()
{
	...
	lChann *= lChann; //Square the value
//	lChann = lChann + 0.5; // apply DC offset
	lChann = lChann * 32768; //multiply it by 32768 * 0.5 (stop clippin from dc offset)
	short s = (short) (lChann); //cast to a float
	temp.channel[1] = s; //set the left channel to the new value
